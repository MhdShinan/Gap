                        ...
                        <div class="Cardsection">
                          <div className="maintopicset">
                                ...
                                <div className="container">
                                  <div className="row justify-content-center align-items-center">
                                    {teamMembers.map((member, index) => (
                                      <div
                                        key={index}
                                        className="mx-3 col-sm-4 col-md-4 col-lg-2 text-center fadeInUp d-flex flex-column align-items-center"
                                      >
                                        <div className="">
                                          <img
                                            src={member.img}
                              ...
                              <div className="d-flex justify-content-center">
                                <div className="container">
                                  <div className="row justify-content-center align-items-center">
                                    ...
                                    <div className="w-100 mt-4 mb-4"></div>
                                    {teamMembersVersion2
                                      .slice(4)
                                      .map((member, index) => (
                                        <div
                            ...
                            <div className="dtabox">
                              ...
                              <div className="d-flex justify-content-center">
                                <div className="container">
                                  <div className="row justify-content-center align-items-center">
                                    {teamMembersVersion3.map(
                                      (member, index) => (
                                        <React.Fragment key={index}>
                                          <div className="mx-3 col-sm-4 col-md-4 col-lg-2 text-center fadeInUp d-flex flex-column align-items-center">
                                            <div className="pbtn2oo">
                                              <img
                                                src={member.img}
                                                alt={member.name}
                          ...
                          <div className="card">
                            ...
                            <p className="responsive-TC-para">
                              ...
                              <br></br> <br></br>Our Platform Integrates With
                              Google Services, Obtaining Necessary Permissions
                              From Users' Gmail Accounts To Generate Google Meet
                              Links, Send Emails To Relevant Recipients, And
                              Schedule Events Directly In Their Calendars.
                            </p>
                          </div>
                          <div className="card ">
                            <div className="d-flex justify-content-between margin-top-css-add">
